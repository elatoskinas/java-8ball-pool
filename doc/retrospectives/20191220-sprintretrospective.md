...
| Cue Ball Reset          | Cue Ball Reset                | Dany                  | 2                | 1 hour 30 minutes  | Yes                            | Done, not yet merged                                                                                 |
| Storage of Player Stats | Player Stats                  | Dany                  | 2                | > 4                | Code is, not the test coverage | Not done as the test coverage did not match the 80%                                                  |
| Player Stats            | Player Stats                  | Dany                  | 2                | 3 hours 30 minutes | Yes                            | Done, not yet merged                                                                                 |
